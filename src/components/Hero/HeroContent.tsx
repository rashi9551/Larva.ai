...
const HeroContent = () => {
  ...
  const handleDownloadPDF = () => {
    if (notes) {
      const filename = wasStopped
        ? "larva-ai-partial-notes"
        : "larva-ai-study-notes";
    ...
    <div className="relative min-h-screen w-full overflow-hidden">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2
                      ...
                      justify-center w-auto md:w-auto" /* Keep width flexible for content */
          >
            <div
            ...
            <div className="p-2">
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 
                          ...
                          active:bg-white/15 transition-colors text-base
                          rounded-lg"
              >
                <LogOut size={18} />
                <span>Sign Out</span>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col items-center w-full max-w-6xl mx-auto px-4 pt-10 sm:pt-20 pb-32">
          ...
          >
            <motion.h1
  className="my-8 text-center text-[28px] font-bold leading-[0.9em] tracking-tighter text-[#e4ded7]
             pt-20 sm:pt-0        
             sm:text-[45px] md:text-[60px] lg:text-[80px]"
                    ...
                    <div className="flex items-center gap-3">
                      {streamingComplete && (
                        <motion.button
                          ...
                          className="flex items-center gap-2
                 px-3 py-2 text-sm md:px-4 md:py-2 md:text-base /* Adjust padding and text size */
                 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700
                 text-white rounded-lg transition-all duration-200
                 hover:scale-105 active:scale-95
                 w-auto justify-center md:w-auto" /* Ensure width adapts */
                        >
                          <Download size={16} />
                          <span className="hidden sm:inline">
                            Download
                          </span>{" "}
                          {/* Hide on small, show on sm+ */}
